...
namespace Unity.FPS.UI
{
    ...
    public class AmmoCounter : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //     Time.deltaTime * 10);
            //Zoom in when select weapon
            // RectTransform rectTransform = AmmoFillImage.rectTransform;
            // rectTransform.anchoredPosition = new Vector2(rectTransform.anchoredPosition.x, rectTransform.anchoredPosition.y - 5); // Adjust the Y position to add space
            // rectTransform.sizeDelta = new Vector2(rectTransform.sizeDelta.x, rectTransform.sizeDelta.y - 10); // Adjust the height to add space
