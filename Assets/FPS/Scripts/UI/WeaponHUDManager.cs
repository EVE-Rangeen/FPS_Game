...
namespace Unity.FPS.UI
{
    public class WeaponHUDManager : MonoBehaviour
    {
        ...
        void AddWeapon(WeaponController newWeapon, int weaponIndex)
        {
            ...
            // RectTransform rectTransform = ammoCounterInstance.GetComponent<RectTransform>();
            // float spacing = 10f; // Adjust this value to add more or less space
            // rectTransform.anchoredPosition = new Vector2(rectTransform.anchoredPosition.x, rectTransform.anchoredPosition.y - weaponIndex * spacing);
